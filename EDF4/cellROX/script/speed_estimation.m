...
%     for th = [0.05:0.01:0.35]
    for j = 1:height(kymograph)
        ...
        % keep the wavefront within the period [frame_strt, frame_stop]
...
%         cy5Speed = [cy5Speed;th p{1}(1)/3600];
% 
%     end
    end
