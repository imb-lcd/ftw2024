...
%% slice images
target_length = 5000; % um
px_length = ceil(target_length/1.266); % number of pixels to keep

for j = 4:19 % range of frames to slice
    ...
    % save sliced images
    % imwrite(crop,"..\img\s19_cy5_ff1_10_sliced.tif","WriteMode","append")
end